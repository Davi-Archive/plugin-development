...
<table class="form-table mv-testimonials-metabox">
    ...
    <tr>
        ...
        <td>
            <input type="text" name="mv_testimonials_occupation" id="mv_testimonials_occupation" class="regular-text occupation" value="<?= isset($occupation) ? esc_html($occupation) : '' ?>">
        </td>
    </tr>
    <tr>
        <th>
        ...
        <td>
            <input type="text" name="mv_testimonials_company" id="mv_testimonials_company" class="regular-text company" value="<?= isset($company) ? esc_html($company) : '' ?>">
        </td>
    </tr>
    <tr>
        <th>
        ...
        <td>
            <input type="url" name="mv_testimonials_user_url" id="mv_testimonials_user_url" class="regular-text user-url" value="<?= isset($user_url) ? esc_url($user_url) : '' ?>">
        </td>
    </tr>
</table>